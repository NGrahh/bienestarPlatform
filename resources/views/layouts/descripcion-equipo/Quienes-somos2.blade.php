                        ...
                        <div align="center" class="pt-4 pb-2">
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-4 mt-5">
                                    <img src="{{url('equipo/RogerSail.png')}}" alt="Editar usuario" data-bs-toggle="modal" data-bs-target="#editUserModal" title="Roger" style="cursor:pointer; width: 300px; height: auto;" class="rounded img-with-shadow-green">
                                </div>
                                <div class="col-12 col-lg-4 mt-5">
