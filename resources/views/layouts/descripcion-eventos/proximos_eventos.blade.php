                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-sm-4 mt-4">
                            <div class="eventocard card" style="max-width: 540px;">
                                <div class="row g-0">
                                    <div class="col-md-4">
                                        <img src="{{ asset('eventoimg/imgs/' . $event->picture) }}" class="rounded-start img-fluid" style="object-fit: cover; width: 100%; height: 100%; aspect-ratio: 1/1" width="100px" height="200px">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            <h5 class="card-title" style="max-width: 200px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">{{ $event->eventname }}</h5>
