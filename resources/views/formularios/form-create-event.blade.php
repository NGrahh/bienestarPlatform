                  ...
                  <div class="card-body">
                    ...
                    <div id="form_appointment" style="display: none;">
                      <form action="{{route('formularios.form-appointment')}}" class="row g-3 needs-validation" novalidate method="POST">
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                          <label for="yourlastname" class="form-label">Fecha del evento.</dl></label>
                        ...
                        <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                          <div class="row mb-3">
                            <label for="inputDate" class="form-label">Fecha Inicio de inscripcion</label>
                            <div class="col-sm-12">
                              <input name="date" type="date" class="form-control" required>
                              <div class="invalid-feedback">Ingrese la fecha de inicio de inscripcion</div>
                              @error('date')
                                <li class="text-danger">{{ $message}}</li>
                              @enderror
                            </div>
