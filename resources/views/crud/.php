                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-grid gap-2 d-md-block">
                                                <a class="btn btn-ba-amarillo px-2" href="{{ route('users.edit', $user->id) }}"><i class="bx bxs-user-detail"></i></a>
                                                <a class="btn btn-ba-rojo px-2" href="{{ route('users.destroy', $user->id) }}"><i class="bx bxs-user-x"></i></a>
                                            </div>
