                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>2005/02/11</td>
                                    <td>2005/02/11</td>
                                    <td> <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#largeModal">
                                            +
                                        </button>
                                        ...
                                        </div><!-- End +--> <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#largeModal">
                                            +
                                        </button>
